...
status_t BufferQueueConsumer::acquireBuffer(BufferItem* outBuffer,
    ...
    uint64_t acquiredBufferId = 0;
    {
        ...
        const bool forceDrop = (mCore->mPresentMode == ANATIVEWINDOW_PRESENT_FIFO_LATEST_READY);
        ...
        if (((expectedPresent != 0) || forceDrop) && !mCore->mQueue.empty()) {
            ...
            while (mCore->mQueue.size() > 1 && (forceDrop || !mCore->mQueue[0].mIsAutoTimestamp)) {
                ...
                if (!forceDrop) {
                    ...
                    if (desiredPresent < expectedPresent - MAX_REASONABLE_NSEC ||
                        ...
                        BQ_LOGV("acquireBuffer: nodrop desire=%" PRId64 " expect=%" PRId64
                                " (%" PRId64 ") now=%" PRId64,
